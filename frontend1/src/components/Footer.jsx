    ...
    <footer style={styles.footer}>
      <div style={styles.container}>
        ...
        <div style={styles.main}>
          ...
          {/* Locations */}
          <div style={styles.links}>
            <h4 style={styles.linkTitle}>📍 Locations</h4>
            <a href="#" style={styles.link}>🏙️ Bengaluru Central</a>
            <a href="#" style={styles.link}>🌆 Koramangala</a>
            <a href="#" style={styles.link}>🌃 Indiranagar</a>
            <a href="#" style={styles.link}>🏔️ Ramanagara</a>
            <a href="#" style={styles.link}>🌊 Mysuru Road</a>
          </div>

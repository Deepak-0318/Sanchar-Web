...
export default function GetStarted() {
  ...
  const handleNearbySearch = async () => {
    ...
    setLoading(true);
    try {
      // Call backend API to find nearby places
      ...
      if (response.ok) {
        ...
        // Navigate to planner with nearby places data
        navigate("/planner", {
          state: {
            mood: answers.mood,
            budget: answers.budget,
            ...
            preferredLocation: "Nearby Places",
      ...
      alert('Failed to find nearby places. Please try again or enter a specific location.');
    } finally {
      setLoading(false);
    }
  };
